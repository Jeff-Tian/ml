...
Plotly.newPlot(
    'error-plot',
    [
        getSeries(details1, '\\eta = ' + eta1),
        getSeries(details2, '\\eta = ' + eta2),
        getSeries(details3, '\\eta = ' + eta3)
    ],
    { margin: { t: 0 } },
    {
...
// // Render KaTeX in legends
// const legendLabels = document.querySelectorAll('.legendtext');
// legendLabels.forEach((label) => {
//     label.innerHTML = label.textContent + katex.renderToString(label.textContent, { throwOnError: false });
// });